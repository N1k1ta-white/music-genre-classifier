...
# %% [markdown]
# Следващият подход се базира на принципа „разделяй и властвуй“: за всеки супер-клас ще се тренира отделен модел. Тази стратегия е обоснована от факта, че супер-класовете съдържат жанрове с подобни характеристики. Моделът, обучен върху конкретен супер-клас, ще може по-ефективно да разграничавa фино сходните жанрове, без да се разсейва от наличието на голям брой несвързани жанрове. По този начин се концентрираме върху най-значимите и релевантни жанрове в контекста на съответния супер-клас, което подобрява точността и интерпретируемостта на предсказанията.

# %% [markdown]
# За обучението на моделите ще използваме вече филтрирания датафрейм, който съдържа хомогенни и репрезентативни примери. Това гарантира, че моделите ще се тренират върху данни с минимален шум и ще могат да научат стабилни и характерни особености на жанровете във всеки супер-клас.
