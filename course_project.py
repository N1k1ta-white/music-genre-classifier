...
# %% [markdown]
# Cluster 0: "The Wall of Sound" (28k songs) - RE-CLUSTER
#
# Cluster 1: "The High-BPM Machine" (11k songs)
# Content: Techno, Grindcore, Black Metal, DnB.
# The Logic: This is pure Tempo (Speed). Grindcore and Techno are both extremely fast genres (160+ BPM).
#
# Cluster 2: "The Global Party" (27k songs) - RE-CLUSTER
#
# Cluster 3: "Warm & Regional" (6.5k songs)
# Content: Pagode, Sertanejo, Samba, Gospel, MPB.
# The Logic: This cluster captured a specific Brazilian/Warm Sound. These genres share specific percussion and vocal styles. Surprisingly coherent cultural clustering.
#
# Cluster 4: "The Emotional Ballad" (18k songs)
# Content: Romance, Jazz, Opera, Acoustic, Folk.
# The Logic: Low Energy, High Acousticness, focus on Vocals. 
# Great for "Dinner" or "Date Night" classification.
#
# Cluster 5: "The Speech Bucket" (850 songs) - PERFERCT 90% comedy, exclude this from music training!
#
# Cluster 6: "Pure Calm" (4.5k songs) - Sleep/Meditation
# Content: New-age, Ambient, Piano, Classical.
# The Logic: Zero beat, high instrumentalness, low energy.
#
# Cluster 7: "Manic Energy" (9.8k songs)
# Content: Happy, Hardstyle, Punk, J-Idol, Metalcore.
# The Logic: This is similar to Cluster 0 but likely has higher Valence (Happiness) and higher BPM. Think "Upbeat aggression" (Punk/Hardstyle) vs "Dark aggression" (Cluster 0)
#
# Cluster 8: "The Groove" (3.5k songs)
# Content: J-Dance, Dancehall, Funk, Kids.
# The Logic: High Groove/Bounce. Distinct from the "Flow" of Cluster 2.
#
